...
const DoubleQuestionEssay = ({ data, answer, onChange, wordCount }) => {
    ...
    return (
        <div className="flex flex-col lg:flex-row h-full gap-6">
            ...
            <div className="w-full lg:w-1/2 overflow-y-auto p-6 bg-white rounded-xl shadow-sm border border-gray-100">
                ...
                <div className="bg-indigo-50 p-6 rounded-xl border-l-4 border-indigo-500 mb-6">
...
export default DoubleQuestionEssay;
