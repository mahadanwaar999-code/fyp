...
const TableTask = ({ data, answer, onChange, wordCount }) => {
    ...
    return (
        <div className="flex flex-col lg:flex-row h-full gap-6">
            ...
            <div className="w-full lg:w-1/2 overflow-y-auto p-6 bg-white rounded-xl shadow-sm border border-gray-100">
                ...
                {/* Table Placeholder */}
                <div className="my-6 p-8 bg-orange-50 rounded-xl border-2 border-dashed border-orange-300 flex flex-col items-center justify-center text-center min-h-[300px]">
                    <div className="text-5xl mb-4">📋</div>
                    <p className="font-bold text-orange-700 text-lg">Table</p>
                    <p className="text-sm text-orange-500 mt-2">[Visual will be displayed here]</p>
                </div>
