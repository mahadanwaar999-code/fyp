...
const BarChartTask = ({ data, answer, onChange, wordCount }) => {
        ...
        <div className="flex flex-col lg:flex-row h-full gap-6">
            ...
            <div className="w-full lg:w-1/2 overflow-y-auto p-6 bg-white rounded-xl shadow-sm border border-gray-100">
                ...
                {data.imageUrl ? (
                    ...
                    <div className="my-6 p-8 bg-blue-50 rounded-xl border-2 border-dashed border-blue-300 flex flex-col items-center justify-center text-center min-h-[300px]">
                        <div className="text-5xl mb-4">📊</div>
                        <p className="font-bold text-blue-700 text-lg">Bar Chart</p>
                        <p className="text-sm text-blue-500 mt-2">[Visual will be displayed here]</p>
                    </div>
                )}
