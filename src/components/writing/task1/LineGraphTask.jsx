...
const LineGraphTask = ({ data, answer, onChange, wordCount }) => {
    ...
    return (
        <div className="flex flex-col lg:flex-row h-full gap-6">
            ...
            <div className="w-full lg:w-1/2 overflow-y-auto p-6 bg-white rounded-xl shadow-sm border border-gray-100">
                ...
                <div className="my-6 p-8 bg-green-50 rounded-xl border-2 border-dashed border-green-300 flex flex-col items-center justify-center text-center min-h-[300px]">
                    <div className="text-5xl mb-4">📈</div>
                    <p className="font-bold text-green-700 text-lg">Line Graph</p>
                    <p className="text-sm text-green-500 mt-2">[Visual will be displayed here]</p>
                </div>
